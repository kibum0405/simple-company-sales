<template>
    <div style="max-height:80vh;">
        ...
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
            ...
            <v-btn @click="createSalesOrderDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('SalePerson')">
                <v-icon small>mdi-minus-circle-outline</v-icon>CreateSalesOrder
            </v-btn>
            ...
            <v-btn @click="updateSalesOrderDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('SalePerson')">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','salesPerson','status','companyId','salesType','salesItems',]" />
    ...
    methods:{
        createSalesOrder(params){
            try{
                ...
                this.$EventBus.$emit('show-success','CreateSalesOrder 성공적으로 처리되었습니다.')
                this.createSalesOrderDialog = false
            }catch(e){
        ...
        updateSalesOrder(params){
            try{
                ...
                this.updateSalesOrderDialog = false
            }catch(e){
                this.$EventBus.$emit('show-error', e);
            }
